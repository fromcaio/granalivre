...
\titulo{Grana Livre}
\autor{Caio Reis (Desenvolvedor e Mantenedor do Projeto) \and Felipe (Desenvolvedor) \and Gabriel (Desenvolvedor) \and Sandro (Desenvolvedor)}
\cliente{Termo de Abertura de Projeto (TAP)}
\local{City, State}
\data{\the\year}
